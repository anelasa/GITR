...
def plotTracks(filename='output/history.nc',geomFile='input/gitrGeometry.cfg',plot=1): #gitrGeometry.cfg',plot=1):
...
if __name__ == "__main__":
    plotTracks(filename='output/history.nc',geomFile='input/gitrGeometry.cfg',plot=1) #gitrD3DGeometry2DWringsPy.cfg',plot=1)
